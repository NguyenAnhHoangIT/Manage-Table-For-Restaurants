 ...
 * @author Admin
 */
@WebServlet(name = "remove_hoadon", urlPatterns = {"/remove_hoadon"})
public class remove_hoadon extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet remove_hoadon</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet remove_hoadon at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        if (id != null) {
            ...
            if(cart_list != null) {
                for(CHITIETHOADON c:cart_list){
                    if(c.getMaDoUong_ID() == Integer.parseInt(id)) {
